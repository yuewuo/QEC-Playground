...
# RUST_BACKTRACE=full cargo run --release -- tool fault_tolerant_benchmark [11] [0] [0.1] -p0 -m100000000 --use_xzzx_code --shallow_error_on_bottom -e1000000 --bias_eta 0.5
# RUST_BACKTRACE=full cargo run --release -- tool fault_tolerant_benchmark [11] [0] [0.1] -p0 -m100000000 --use_xzzx_code --shallow_error_on_bottom -e1000000 --bias_eta +inf
...
# UF_parameters = f"-p0 --shallow_error_on_bottom --use_xzzx_code --time_budget 3600".split(" ")

# for debug
UF_parameters = f"-p0 --shallow_error_on_bottom --use_xzzx_code --time_budget 10".split(" ")
