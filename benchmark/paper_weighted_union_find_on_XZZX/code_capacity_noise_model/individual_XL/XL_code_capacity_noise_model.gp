...
set title "Logical X only"

set output "XL_code_capacity_noise_model.eps"

plot "XL_MWPM_d11_p0.1.txt" using 1:6 with linespoints lt rgb "red" linewidth 5 pointtype 6 pointsize 1.5 title "MWPM, d = 11",\
    "" using 1:6:($6*(1-$7)):($6*(1+$7)) with errorbars lt rgb "red" linewidth 5 pointtype 6 pointsize 1.5 notitle,\
    "XL_UF_d11_p0.1.txt" using 1:6 with linespoints lt rgb "blue" linewidth 5 pointtype 2 pointsize 1.5 title "UnionFind, d = 11",\
    "" using 1:6:($6*(1-$7)):($6*(1+$7)) with errorbars lt rgb "blue" linewidth 5 pointtype 2 pointsize 1.5 notitle,\
    "XL_MWPM_d13_p0.1.txt" using 1:6 with linespoints lt rgb "orange" linewidth 5 pointtype 6 pointsize 1.5 title "MWPM, d = 13",\
