...
parameters = f"-p{STO(0)} --time_budget {3600*1} --code_type StandardXZZXCode --bias_eta 100 --decoder union-find".split(" ")
parameters += ["--decoder_config", f"{{\"pcmg\":true,\"use_real_weighted\":false,\"max_half_weight\":1,\"use_combined_probability\":false}}"]
