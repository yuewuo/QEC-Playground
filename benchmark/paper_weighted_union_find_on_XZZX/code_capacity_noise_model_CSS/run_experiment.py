...
UF_parameters = f"-p{STO(0)} --decoder UF --max_half_weight 100 --time_budget {3600*3*4} --shallow_error_on_bottom".split(" ")  # a maximum 20min for each point
MWPM_parameters = f"-p{STO(0)} --time_budget {3600*3*4} --shallow_error_on_bottom".split(" ")
