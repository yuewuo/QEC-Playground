...
set output "debug_code_capacity_noise_model.eps"

plot "MWPM_d5_p0.07.txt" using 1:6 with linespoints lt rgb "red" linewidth 3 pointtype 7 pointsize 1 title "MWPM, d = 5",\
    "" using 1:6:($6*(1-$7)):($6*(1+$7)) with errorbars lt rgb "red" linewidth 3 pointtype 7 pointsize 1 notitle,\
    "UF_d5_p0.07.txt" using 1:6 with linespoints lt rgb "blue" linewidth 3 pointtype 11 pointsize 1 title "UnionFind, d = 5",\
    "" using 1:6:($6*(1-$7)):($6*(1+$7)) with errorbars lt rgb "blue" linewidth 3 pointtype 11 pointsize 1 notitle

system("ps2pdf -dEPSCrop debug_code_capacity_noise_model.eps debug_code_capacity_noise_model.pdf")

# set size 1,0.75
# set output "debug_code_capacity_noise_model_w.eps"
# replot
# system("ps2pdf -dEPSCrop debug_code_capacity_noise_model_w.eps debug_code_capacity_noise_model_w.pdf")

# set size 1,0.6
# set output "debug_code_capacity_noise_model_w_w.eps"
# replot
# system("ps2pdf -dEPSCrop debug_code_capacity_noise_model_w_w.eps debug_code_capacity_noise_model_w_w.pdf")
