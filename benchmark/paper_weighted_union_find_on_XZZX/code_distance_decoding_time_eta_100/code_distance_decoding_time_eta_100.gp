...
plot exp(3 * log(x) + intercept0002) notitle with lines dashtype 2 lt rgb "#e41a1c" linewidth 3,\
    ...
    "processed_UF_0.0002.txt" using 1:5 with linespoints lt rgb "#e41a1c" linewidth 3 pointtype 11 pointsize 1 title "0.0002",\
    "processed_UF_0.0005.txt" using 1:5 with linespoints lt rgb "#377eb8" linewidth 3 pointtype 11 pointsize 1 title "0.0005",\
    "processed_UF_0.001.txt" using 1:5 with linespoints lt rgb "#4daf4a" linewidth 3 pointtype 11 pointsize 1 title "0.001",\
    "processed_UF_0.002.txt" using 1:5 with linespoints lt rgb "#ff7f00" linewidth 3 pointtype 11 pointsize 1 title "0.002",\
    "processed_UF_0.004.txt" using 1:5 with linespoints lt rgb "#984ea3" linewidth 3 pointtype 11 pointsize 1 title "0.004",\
    "processed_UF_0.008.txt" using 1:5 with linespoints lt rgb "black" linewidth 3 pointtype 11 pointsize 1 title "0.008"
