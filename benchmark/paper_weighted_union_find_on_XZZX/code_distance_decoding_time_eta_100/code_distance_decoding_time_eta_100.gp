...
#     "" using 1:10 with linespoints lt rgb "green" linewidth 3 pointtype 7 pointsize 1 title "MWPM Average",\
    ...
    slope0002 = "`tail -n1 processed_UF_0.0002.txt | awk '{print $2}' | head -n1`"+0
intercept0002 = "`tail -n1 processed_UF_0.0002.txt | awk '{print $3}' | head -n1`"+0
    slope0005 = "`tail -n1 processed_UF_0.0005.txt | awk '{print $2}' | head -n1`"+0
intercept0005 = "`tail -n1 processed_UF_0.0005.txt | awk '{print $3}' | head -n1`"+0
    slope001 = "`tail -n1 processed_UF_0.001.txt | awk '{print $2}' | head -n1`"+0
intercept001 = "`tail -n1 processed_UF_0.001.txt | awk '{print $3}' | head -n1`"+0
    slope002 = "`tail -n1 processed_UF_0.002.txt | awk '{print $2}' | head -n1`"+0
intercept002 = "`tail -n1 processed_UF_0.002.txt | awk '{print $3}' | head -n1`"+0
    slope004 = "`tail -n1 processed_UF_0.004.txt | awk '{print $2}' | head -n1`"+0
intercept004 = "`tail -n1 processed_UF_0.004.txt | awk '{print $3}' | head -n1`"+0
    slope008 = "`tail -n1 processed_UF_0.008.txt | awk '{print $2}' | head -n1`"+0
intercept008 = "`tail -n1 processed_UF_0.008.txt | awk '{print $3}' | head -n1`"+0
...
plot "processed_UF_0.0002.txt" using 1:($5) with linespoints lt rgb "red" linewidth 3 pointtype 11 pointsize 1 title "0.0002",\
    fit1(x) notitle with lines linestyle 2,\
    "processed_UF_0.0005.txt" using 1:($5) with linespoints lt rgb "red" linewidth 3 pointtype 11 pointsize 1 title "0.0005",\
    fit1(x) notitle with lines linestyle 2,\
    "processed_UF_0.001.txt" using 1:($5) with linespoints lt rgb "red" linewidth 3 pointtype 11 pointsize 1 title "0.001",\
    fit1(x) notitle with lines linestyle 2,\
    "processed_UF_0.002.txt" using 1:($5) with linespoints lt rgb "red" linewidth 3 pointtype 11 pointsize 1 title "0.002",\
    fit1(x) notitle with lines linestyle 2,\
    "processed_UF_0.004.txt" using 1:($5) with linespoints lt rgb "red" linewidth 3 pointtype 11 pointsize 1 title "0.004",\
    fit1(x) notitle with lines linestyle 2,\
    "processed_UF_0.008.txt" using 1:($5) with linespoints lt rgb "red" linewidth 3 pointtype 11 pointsize 1 title "0.008",\
    fit1(x) notitle with lines linestyle 2
