...
plot "processed_MWPM.txt" using 1:5 with linespoints lt rgb "red" linewidth 3 pointtype 7 pointsize 1 title "MWPM 1.1x",\
    ...
    "processed_UF_0.001.txt" using 1:($5/100) with linespoints lt rgb "light-red" linewidth 3 pointtype 11 pointsize 1 title "UF 0.001",\
    "processed_UF_0.0003.txt" using 1:($5/100) with linespoints lt rgb "light-blue" linewidth 3 pointtype 11 pointsize 1 title "UF 0.0003",\
    "processed_UF_0.0001.txt" using 1:($5/100) with linespoints lt rgb "light-green" linewidth 3 pointtype 11 pointsize 1 title "UF 0.0001"
