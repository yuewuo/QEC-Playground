...
parameters = f"-p{STO(0)} --time_budget {3600*3*4} --code_type StandardXZZXCode --bias_eta 100 --decoder union-find".split(" ")
parameters += ["--decoder_config", f"{{\"pcmg\":true,\"use_real_weighted\":true,\"max_half_weight\":9223372036854775807,\"use_combined_probability\":false}}"]
