...
set title "Code-Capacity Noise Rotated Surface Code"
...
set output "rotated_planar_code_capacity.eps"
...
system("ps2pdf -dEPSCrop rotated_planar_code_capacity.eps rotated_planar_code_capacity.pdf")
