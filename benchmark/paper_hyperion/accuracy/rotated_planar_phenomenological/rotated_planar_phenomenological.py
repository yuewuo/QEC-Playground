...
simulation_parameters = f"""-p{STO(0)} --code-type rotated-planar-code --noise-model stim-noise-model --ignore-logical-i --noise-model-configuration {{"after_clifford_depolarization":0,"after_reset_flip_probability":0}}""".split(" ")
