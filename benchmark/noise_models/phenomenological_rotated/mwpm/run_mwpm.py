...
UF_parameters = f"""-p{STO(0)} --code-type rotated-planar-code --ignore-logical-i --decoder fusion --time-budget {CH(10)} --noise-model stim-noise-model --noise-model-configuration {{"after_clifford_depolarization":0,"after_reset_flip_probability":0}}""".split(" ")
