...
system("ps2pdf -dEPSCrop UF.eps UF.pdf")

# set size 1,0.75
# set output "UF_w.eps"
# replot
# system("ps2pdf -dEPSCrop UF_w.eps UF_w.pdf")

# set size 1,0.6
# set output "UF_w_w.eps"
# replot
# system("ps2pdf -dEPSCrop UF_w_w.eps UF_w_w.pdf")
