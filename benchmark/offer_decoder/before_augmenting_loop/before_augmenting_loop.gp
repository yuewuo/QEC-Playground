...
system("ps2pdf -dEPSCrop before_augmenting_loop.eps before_augmenting_loop.pdf")

set size 1,0.75
set output "before_augmenting_loop_w.eps"
replot
system("ps2pdf -dEPSCrop before_augmenting_loop_w.eps before_augmenting_loop_w.pdf")

set size 1,0.6
set output "before_augmenting_loop_w_w.eps"
replot
system("ps2pdf -dEPSCrop before_augmenting_loop_w_w.eps before_augmenting_loop_w_w.pdf")
