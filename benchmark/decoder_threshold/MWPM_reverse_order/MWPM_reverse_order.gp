...
# cargo run --release --features MWPM_reverse_order -- tool fault_tolerant_benchmark [11,21,31] [0,0,0] [9.5e-2,9.6e-2,9.7e-2,9.8e-2,9.9e-2,10e-2,10.1e-2,10.2e-2,10.3e-2,10.4e-2,10.5e-2] -p0 -b1000 -e1000000 -m1000000 --shallow_error_on_bottom --only_count_logical_x --no_autotune --no_y_error
