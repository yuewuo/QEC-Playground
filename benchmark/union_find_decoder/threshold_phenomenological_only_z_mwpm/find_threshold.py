...
def example_qecp_benchmark_simulate_func(p, d, runtime_budget, p_graph=None):
    ...
    parameters = f"""-p0 --code-type rotated-planar-code --noise-model phenomenological --bias-eta 1e200 --decoder union-find --decoder-config {{"pcmg":true,"max_half_weight":20,"use_real_weighted":true}}""".split(" ")
