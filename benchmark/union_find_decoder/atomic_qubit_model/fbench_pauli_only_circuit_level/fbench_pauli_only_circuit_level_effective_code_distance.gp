...
set output "fbench_pauli_only_circuit_level_effective_code_distance.eps"

set title "FBench Pauli Only Circuit-Level d_{eff}"
...
system("ps2pdf -dEPSCrop fbench_pauli_only_circuit_level_effective_code_distance.eps fbench_pauli_only_circuit_level_effective_code_distance.pdf")

# set size 1,0.75
# set output "fbench_pauli_only_circuit_level_effective_code_distance_w.eps"
# replot
# system("ps2pdf -dEPSCrop fbench_pauli_only_circuit_level_effective_code_distance_w.eps fbench_pauli_only_circuit_level_effective_code_distance_w.pdf")

# set size 1,0.6
# set output "fbench_pauli_only_circuit_level_effective_code_distance_w_w.eps"
# replot
# system("ps2pdf -dEPSCrop fbench_pauli_only_circuit_level_effective_code_distance_w_w.eps fbench_pauli_only_circuit_level_effective_code_distance_w_w.pdf")
