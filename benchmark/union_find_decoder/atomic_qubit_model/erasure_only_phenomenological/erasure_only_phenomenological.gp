...
set output "erasure_only_phenomenological.eps"
...
set output '|ps2pdf -dEPSCrop erasure_only_phenomenological.eps erasure_only_phenomenological.pdf'
replot

# set size 1,0.75
# set output "erasure_only_phenomenological_w.eps"
# replot
# set output '|ps2pdf -dEPSCrop erasure_only_phenomenological_w.eps erasure_only_phenomenological_w.pdf'
# replot

# set size 1,0.6
# set output "erasure_only_phenomenological_w_w.eps"
# replot
# set output '|ps2pdf -dEPSCrop erasure_only_phenomenological_w_w.eps erasure_only_phenomenological_w_w.pdf'
# replot
