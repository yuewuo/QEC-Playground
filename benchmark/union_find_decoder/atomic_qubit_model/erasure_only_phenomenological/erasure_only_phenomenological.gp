...
system("ps2pdf -dEPSCrop erasure_only_phenomenological.eps erasure_only_phenomenological.pdf")

# set size 1,0.75
# set output "erasure_only_phenomenological_w.eps"
# replot
# system("ps2pdf -dEPSCrop erasure_only_phenomenological_w.eps erasure_only_phenomenological_w.pdf")

# set size 1,0.6
# set output "erasure_only_phenomenological_w_w.eps"
# replot
# system("ps2pdf -dEPSCrop erasure_only_phenomenological_w_w.eps erasure_only_phenomenological_w_w.pdf")
