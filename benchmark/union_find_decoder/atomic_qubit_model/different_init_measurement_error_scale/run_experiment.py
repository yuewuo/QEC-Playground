...
def experiment(slurm_commands_vec = None, run_command_get_stdout=run_qec_playground_command_get_stdout):
    ...
    for di in di_vec:
        ...
        for p in p_vec:
            ...
            parameters = f"-p{STO(0)} --decoder UF --max_half_weight 10 --time_budget {3600*3} --use_xzzx_code --noise_model OnlyGateErrorCircuitLevelCorrelatedErasure".split(" ") + ["--noise_model_configuration", noise_model_configuration]  # a maximum 20min for each point
