...
set logscale y
set ytics ("10^{-8}" 0.00000001, "10^{-7}" 0.0000001, "10^{-6}" 0.000001, "10^{-5}" 0.00001, "10^{-4}" 0.0001, "10^{-3}" 0.001, "10^{-2}" 0.005, "10^{-1}" 0.1)
...
set title "Atomic Qubit Init Measure Error 0.005"
...
set output '|ps2pdf -dEPSCrop init_measurement_error_0.005.eps init_measurement_error_0.005.pdf'
replot

# set size 1,0.75
# set output "init_measurement_error_0.005_w.eps"
# replot
# set output '|ps2pdf -dEPSCrop init_measurement_error_0.005_w.eps init_measurement_error_0.005_w.pdf'
# replot

# set size 1,0.6
# set output "init_measurement_error_0.005_w_w.eps"
# replot
# set output '|ps2pdf -dEPSCrop init_measurement_error_0.005_w_w.eps init_measurement_error_0.005_w_w.pdf'
# replot
