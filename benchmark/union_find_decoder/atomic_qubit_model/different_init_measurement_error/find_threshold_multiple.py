...
parameters = "-p0 --decoder UF --max_half_weight 10 --time_budget 300 --use_xzzx_code --error_model OnlyGateErrorCircuitLevelCorrelatedErasure".split(" ")
...
def make_simulator_runner(init_measurement_error_rate):
...
results = []
for init_measurement_error_rate in [0.001, 0.005, 0.01]:
    simulator_runner = make_simulator_runner(init_measurement_error_rate)
    ...
    results.append(f"{init_measurement_error_rate} {threshold} {relative_confidence_interval}")
    print("\n\n")
