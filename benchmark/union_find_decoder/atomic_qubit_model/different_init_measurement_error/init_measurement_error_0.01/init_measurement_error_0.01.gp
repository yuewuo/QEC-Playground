...
set title "Atomic Qubit Initialization and Measure Error 0.01"
...
set output '|ps2pdf -dEPSCrop init_measurement_error_0.01.eps init_measurement_error_0.01.pdf'
replot

# set size 1,0.75
# set output "init_measurement_error_0.01_w.eps"
# replot
# set output '|ps2pdf -dEPSCrop init_measurement_error_0.01_w.eps init_measurement_error_0.01_w.pdf'
# replot

# set size 1,0.6
# set output "init_measurement_error_0.01_w_w.eps"
# replot
# set output '|ps2pdf -dEPSCrop init_measurement_error_0.01_w_w.eps init_measurement_error_0.01_w_w.pdf'
# replot
