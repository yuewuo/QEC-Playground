...
set output "init_measurement_error_0.1.eps"

set title "Atomic Qubit Init Measure Error 0.1 (0.98p erasure + 0.02p Pauli)" font "Arial, 18"
...
system("ps2pdf -dEPSCrop init_measurement_error_0.1.eps init_measurement_error_0.1.pdf")

# set size 1,0.75
# set output "init_measurement_error_0.1_w.eps"
# replot
# system("ps2pdf -dEPSCrop init_measurement_error_0.1_w.eps init_measurement_error_0.1_w.pdf")

# set size 1,0.6
# set output "init_measurement_error_0.1_w_w.eps"
# replot
# system("ps2pdf -dEPSCrop init_measurement_error_0.1_w_w.eps init_measurement_error_0.1_w_w.pdf")
