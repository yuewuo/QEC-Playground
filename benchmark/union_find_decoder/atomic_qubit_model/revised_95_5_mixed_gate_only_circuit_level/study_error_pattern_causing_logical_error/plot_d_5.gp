...
set output "plot_d_5.eps"

set title "Ratio of Erasure Errors w/ Logical Error (d = 5)"
...
set output '|ps2pdf -dEPSCrop plot_d_5.eps plot_d_5.pdf'
replot

# set size 1,0.75
# set output "plot_d_5_w.eps"
# replot
# set output '|ps2pdf -dEPSCrop plot_d_5_w.eps plot_d_5_w.pdf'
# replot

# set size 1,0.6
# set output "plot_d_5_w_w.eps"
# replot
# set output '|ps2pdf -dEPSCrop plot_d_5_w_w.eps plot_d_5_w_w.pdf'
# replot
