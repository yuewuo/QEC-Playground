...
system("ps2pdf -dEPSCrop plot_d_5.eps plot_d_5.pdf")

# set size 1,0.75
# set output "plot_d_5_w.eps"
# replot
# system("ps2pdf -dEPSCrop plot_d_5_w.eps plot_d_5_w.pdf")

# set size 1,0.6
# set output "plot_d_5_w_w.eps"
# replot
# system("ps2pdf -dEPSCrop plot_d_5_w_w.eps plot_d_5_w_w.pdf")
