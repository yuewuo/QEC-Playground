...
set output '|ps2pdf -dEPSCrop plot_d_9.eps plot_d_9.pdf'
replot

# set size 1,0.75
# set output "plot_d_9_w.eps"
# replot
# set output '|ps2pdf -dEPSCrop plot_d_9_w.eps plot_d_9_w.pdf'
# replot

# set size 1,0.6
# set output "plot_d_9_w_w.eps"
# replot
# set output '|ps2pdf -dEPSCrop plot_d_9_w_w.eps plot_d_9_w_w.pdf'
# replot
