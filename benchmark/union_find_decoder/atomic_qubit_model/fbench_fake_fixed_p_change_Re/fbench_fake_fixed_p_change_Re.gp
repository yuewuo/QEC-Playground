...
set output "fbench_fake_fixed_p_change_Re.eps"

set title "FBench Fixed p Change Re (Fake Decoder)"
...
system("ps2pdf -dEPSCrop fbench_fake_fixed_p_change_Re.eps fbench_fake_fixed_p_change_Re.pdf")

# set size 1,0.75
# set output "fbench_fake_fixed_p_change_Re_w.eps"
# replot
# system("ps2pdf -dEPSCrop fbench_fake_fixed_p_change_Re_w.eps fbench_fake_fixed_p_change_Re_w.pdf")

# set size 1,0.6
# set output "fbench_fake_fixed_p_change_Re_w_w.eps"
# replot
# system("ps2pdf -dEPSCrop fbench_fake_fixed_p_change_Re_w_w.eps fbench_fake_fixed_p_change_Re_w_w.pdf")
