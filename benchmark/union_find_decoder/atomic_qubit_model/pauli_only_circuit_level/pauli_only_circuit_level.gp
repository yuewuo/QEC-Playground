...
system("ps2pdf -dEPSCrop pauli_only_circuit_level.eps pauli_only_circuit_level.pdf")

# set size 1,0.75
# set output "pauli_only_circuit_level_w.eps"
# replot
# system("ps2pdf -dEPSCrop pauli_only_circuit_level_w.eps pauli_only_circuit_level_w.pdf")

# set size 1,0.6
# set output "pauli_only_circuit_level_w_w.eps"
# replot
# system("ps2pdf -dEPSCrop pauli_only_circuit_level_w_w.eps pauli_only_circuit_level_w_w.pdf")
