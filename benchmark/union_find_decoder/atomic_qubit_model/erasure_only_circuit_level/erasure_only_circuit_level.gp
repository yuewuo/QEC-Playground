...
# replot
# set output '|ps2pdf -dEPSCrop erasure_only_circuit_level_w.eps erasure_only_circuit_level_w.pdf'
# replot

# set size 1,0.6
# set output "erasure_only_circuit_level_w_w.eps"
# replot
# set output '|ps2pdf -dEPSCrop erasure_only_circuit_level_w_w.eps erasure_only_circuit_level_w_w.pdf'
# replot
