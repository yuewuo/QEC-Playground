...
set logscale x
set xrange [0.04:1]
set xtics ("0.05" 0.05, "0.1" 0.1, "0.2" 0.2, "0.5" 0.5, "1.0" 1.0)
set logscale y
set yrange [0.000001:1]
set ytics ("1e-6" 0.000001, "1e-5" 0.00001, "1e-4" 0.0001, "1e-3" 0.001, "1e-2" 0.01, "1e-1" 0.1, "1" 1)
...
system("ps2pdf -dEPSCrop visualize_3.eps visualize_3.pdf")

# set size 1,0.75
# set output "visualize_3_w.eps"
# replot
# system("ps2pdf -dEPSCrop visualize_3_w.eps visualize_3_w.pdf")

# set size 1,0.6
# set output "visualize_3_w_w.eps"
# replot
# system("ps2pdf -dEPSCrop visualize_3_w_w.eps visualize_3_w_w.pdf")
