...
set output "revised_95_5_mixed_gate_only_circuit_level_correlated_erasure.eps"

set title "95% Correlated Erasure + 5% Pauli Circuit-Level"
...
set output '|ps2pdf -dEPSCrop revised_95_5_mixed_gate_only_circuit_level_correlated_erasure.eps revised_95_5_mixed_gate_only_circuit_level_correlated_erasure.pdf'
replot

# set size 1,0.75
# set output "revised_95_5_mixed_gate_only_circuit_level_correlated_erasure_w.eps"
# replot
# set output '|ps2pdf -dEPSCrop revised_95_5_mixed_gate_only_circuit_level_correlated_erasure_w.eps revised_95_5_mixed_gate_only_circuit_level_correlated_erasure_w.pdf'
# replot

# set size 1,0.6
# set output "revised_95_5_mixed_gate_only_circuit_level_correlated_erasure_w_w.eps"
# replot
# set output '|ps2pdf -dEPSCrop revised_95_5_mixed_gate_only_circuit_level_correlated_erasure_w_w.eps revised_95_5_mixed_gate_only_circuit_level_correlated_erasure_w_w.pdf'
# replot
