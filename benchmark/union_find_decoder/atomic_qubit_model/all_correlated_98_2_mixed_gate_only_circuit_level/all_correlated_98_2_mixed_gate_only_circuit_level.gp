...
set output "all_correlated_98_2_mixed_gate_only_circuit_level.eps"

set title "98% Erasure + 2% Pauli Circuit-Level"
...
system("ps2pdf -dEPSCrop all_correlated_98_2_mixed_gate_only_circuit_level.eps all_correlated_98_2_mixed_gate_only_circuit_level.pdf")

# set size 1,0.75
# set output "all_correlated_98_2_mixed_gate_only_circuit_level_w.eps"
# replot
# system("ps2pdf -dEPSCrop all_correlated_98_2_mixed_gate_only_circuit_level_w.eps all_correlated_98_2_mixed_gate_only_circuit_level_w.pdf")

# set size 1,0.6
# set output "all_correlated_98_2_mixed_gate_only_circuit_level_w_w.eps"
# replot
# system("ps2pdf -dEPSCrop all_correlated_98_2_mixed_gate_only_circuit_level_w_w.eps all_correlated_98_2_mixed_gate_only_circuit_level_w_w.pdf")
