...
parameters = "-p0 --decoder UF --max_half_weight 100 --time_budget 1200 --use_xzzx_code --error_model GenericBiasedWithBiasedCX --bias_eta 100".split(" ") + ["--error_model_configuration", error_model_configuration]
...
evaluator.searching_upper_bound = 0.10
