...
system("ps2pdf -dEPSCrop atomic_qubit_circuit_noise_model.eps atomic_qubit_circuit_noise_model.pdf")

# set size 1,0.75
# set output "atomic_qubit_circuit_noise_model_w.eps"
# replot
# system("ps2pdf -dEPSCrop atomic_qubit_circuit_noise_model_w.eps atomic_qubit_circuit_noise_model_w.pdf")

# set size 1,0.6
# set output "atomic_qubit_circuit_noise_model_w_w.eps"
# replot
# system("ps2pdf -dEPSCrop atomic_qubit_circuit_noise_model_w_w.eps atomic_qubit_circuit_noise_model_w_w.pdf")
