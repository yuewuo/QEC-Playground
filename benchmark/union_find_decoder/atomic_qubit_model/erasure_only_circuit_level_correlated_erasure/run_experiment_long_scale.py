...
# test examples
# cargo run --release -- tool fault_tolerant_benchmark [3] --djs [3] [3] -m100000000 -e1000 [0] -p0 --decoder UF --max_half_weight 10 --time_budget 3600 --use_xzzx_code --pes [0.2] --error_model OnlyGateErrorCircuitLevelCorrelatedErasure
