...
# set size 1,0.75
# set output "effective_code_distance_pm0.001_w.eps"
# replot
# system("ps2pdf -dEPSCrop effective_code_distance_pm0.001_w.eps effective_code_distance_pm0.001_w.pdf")

# set size 1,0.6
# set output "effective_code_distance_pm0.001_w_w.eps"
# replot
# system("ps2pdf -dEPSCrop effective_code_distance_pm0.001_w_w.eps effective_code_distance_pm0.001_w_w.pdf")
