...
set output "fbench_fake_revised_95_5_mixed_gate_only_circuit_level_effective_code_distance.eps"

set title "FBench Mixed Circuit-Level d_{eff} (Fake Decoder)"
...
system("ps2pdf -dEPSCrop fbench_fake_revised_95_5_mixed_gate_only_circuit_level_effective_code_distance.eps fbench_fake_revised_95_5_mixed_gate_only_circuit_level_effective_code_distance.pdf")

# set size 1,0.75
# set output "fbench_fake_revised_95_5_mixed_gate_only_circuit_level_effective_code_distance_w.eps"
# replot
# system("ps2pdf -dEPSCrop fbench_fake_revised_95_5_mixed_gate_only_circuit_level_effective_code_distance_w.eps fbench_fake_revised_95_5_mixed_gate_only_circuit_level_effective_code_distance_w.pdf")

# set size 1,0.6
# set output "fbench_fake_revised_95_5_mixed_gate_only_circuit_level_effective_code_distance_w_w.eps"
# replot
# system("ps2pdf -dEPSCrop fbench_fake_revised_95_5_mixed_gate_only_circuit_level_effective_code_distance_w_w.eps fbench_fake_revised_95_5_mixed_gate_only_circuit_level_effective_code_distance_w_w.pdf")
