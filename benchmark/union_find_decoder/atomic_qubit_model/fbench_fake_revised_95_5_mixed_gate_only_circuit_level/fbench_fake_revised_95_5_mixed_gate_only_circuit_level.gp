...
set output "fbench_fake_revised_95_5_mixed_gate_only_circuit_level.eps"

set title "FBench Mixed Circuit-Level (Fake Decoder)"
...
system("ps2pdf -dEPSCrop fbench_fake_revised_95_5_mixed_gate_only_circuit_level.eps fbench_fake_revised_95_5_mixed_gate_only_circuit_level.pdf")

# set size 1,0.75
# set output "fbench_fake_revised_95_5_mixed_gate_only_circuit_level_w.eps"
# replot
# system("ps2pdf -dEPSCrop fbench_fake_revised_95_5_mixed_gate_only_circuit_level_w.eps fbench_fake_revised_95_5_mixed_gate_only_circuit_level_w.pdf")

# set size 1,0.6
# set output "fbench_fake_revised_95_5_mixed_gate_only_circuit_level_w_w.eps"
# replot
# system("ps2pdf -dEPSCrop fbench_fake_revised_95_5_mixed_gate_only_circuit_level_w_w.eps fbench_fake_revised_95_5_mixed_gate_only_circuit_level_w_w.pdf")
