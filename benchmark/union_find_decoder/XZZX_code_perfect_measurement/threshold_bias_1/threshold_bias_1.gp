...
# RUST_BACKTRACE=full cargo run --release -- tool union_find_decoder_standard_xzzx_benchmark [13,17,21,25] [0.13,0.15,0.17,0.19] -b1000 -p0 -m100000000 -e10000 --bias_eta 1 --max_half_weight 10

# or joint commands
# RUST_BACKTRACE=full cargo run --release -- tool union_find_decoder_standard_xzzx_benchmark [13,17,21,25] [0.13,0.14,0.15,0.16,0.17,0.18,0.19] -b1000 -p0 -m20000000 -e200000 --bias_eta 1 --max_half_weight 10
