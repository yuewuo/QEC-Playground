...
# RUST_BACKTRACE=full cargo run --release -- tool fault_tolerant_benchmark [13,17,21,25] [0,0,0,0] [0.12,0.14,0.16,0.18] -p0 -b1000 -m100000000 -e10000 --use_xzzx_code --shallow_error_on_bottom --bias_eta 0.5 --decoder UF --max_half_weight 10

# or joint commands
# RUST_BACKTRACE=full cargo run --release -- tool fault_tolerant_benchmark [13,17,21,25] [0,0,0,0] [0.12,0.13,0.14,0.15,0.16,0.17,0.18] -p0 -b1000 -m20000000 -e200000 --use_xzzx_code --shallow_error_on_bottom --bias_eta 0.5 --decoder UF --max_half_weight 10
