...
UF_parameters = f"-p0 --decoder UF --max_half_weight 100 --time_budget 1200 --use_xzzx_code --shallow_error_on_bottom".split(" ")  # a maximum 20min for each point
MWPM_parameters = f"-p0 --time_budget 1200 --use_xzzx_code --shallow_error_on_bottom".split(" ")
    ...
    for di in di_vec:
        for p in p_vec:
            ...
            for bias_eta in bias_eta_vec:
                ...
                # record result
                print_result = f"{bias_eta} {p} {di} {total_rounds} {error_count} {error_rate}"
