...
# RUST_BACKTRACE=full cargo run --release -- tool union_find_decoder_standard_xzzx_benchmark [13,17,21,25] [0.24,0.26,0.28,0.30] -b1000 -p0 -m100000000 -e10000 --bias_eta 10 --max_half_weight 10

# or joint commands
# RUST_BACKTRACE=full cargo run --release -- tool union_find_decoder_standard_xzzx_benchmark [13,17,21,25] [0.24,0.25,0.26,0.27,0.28,0.29,0.30] -b1000 -p0 -m20000000 -e200000 --bias_eta 10 --max_half_weight 10
