...
UF_command = qec_playground_fault_tolerant_MWPM_simulator_runner_vec_command(p_vec, di_vec, dj_vec, T_vec, UF_parameters + ["--log_runtime_statistics", "target/pm_decoding_time_single_low_p.txt"], max_N=max_N, min_error_cases=min_error_cases)
