...
set output '|ps2pdf -dEPSCrop decoding_time_comparison_compare_low_p_high_p.eps decoding_time_comparison_compare_low_p_high_p.pdf'
replot

set size 1,0.75
set output "decoding_time_comparison_compare_low_p_high_p_w.eps"
replot
set output '|ps2pdf -dEPSCrop decoding_time_comparison_compare_low_p_high_p_w.eps decoding_time_comparison_compare_low_p_high_p_w.pdf'
replot

set size 1,0.6
set output "decoding_time_comparison_compare_low_p_high_p_w_w.eps"
replot
set output '|ps2pdf -dEPSCrop decoding_time_comparison_compare_low_p_high_p_w_w.eps decoding_time_comparison_compare_low_p_high_p_w_w.pdf'
replot
