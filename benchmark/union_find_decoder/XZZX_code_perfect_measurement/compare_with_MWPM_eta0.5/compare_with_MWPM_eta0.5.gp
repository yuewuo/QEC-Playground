...
# RUST_BACKTRACE=full cargo run --release -- tool union_find_decoder_standard_xzzx_benchmark [3,5,7,9,11,13,15,17,19] [0.2] -p0 -b1000 -m100000000 -e1000000 --bias_eta 0.5 --max_half_weight 10
...
# RUST_BACKTRACE=full cargo run --release -- tool union_find_decoder_standard_xzzx_benchmark [3,5,7,9,11,13,15,17,19] [0.1] -p0 -b1000 -m100000000 -e1000000 --bias_eta 0.5 --max_half_weight 10
