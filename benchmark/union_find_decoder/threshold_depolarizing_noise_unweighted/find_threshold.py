...
def example_qecp_benchmark_simulate_func(p, d, runtime_budget, p_graph=None):
    ...
    parameters = f"-p0 --code_type StandardPlanarCode --noise_model depolarizing-noise --decoder union-find --decoder_config {{\"pcmg\":true,\"max_half_weight\":1}}".split(" ")
...
rough_popt = [0.14165495942695647, 7.478421313093171, 99.99999999999999, 0.006344848745111815, 0.9104668679380903]
threshold_analyzer.target_relative_diff = 0.04
