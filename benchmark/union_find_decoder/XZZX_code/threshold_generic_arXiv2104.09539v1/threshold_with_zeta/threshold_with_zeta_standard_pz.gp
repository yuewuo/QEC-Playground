...
system("ps2pdf -dEPSCrop threshold_with_zeta_standard_pz.eps threshold_with_zeta_standard_pz.pdf")

set size 1,0.75
set output "threshold_with_zeta_standard_pz_w.eps"
replot
system("ps2pdf -dEPSCrop threshold_with_zeta_standard_pz_w.eps threshold_with_zeta_standard_pz_w.pdf")

set size 1,0.6
set output "threshold_with_zeta_standard_pz_w_w.eps"
replot
system("ps2pdf -dEPSCrop threshold_with_zeta_standard_pz_w_w.eps threshold_with_zeta_standard_pz_w_w.pdf")
