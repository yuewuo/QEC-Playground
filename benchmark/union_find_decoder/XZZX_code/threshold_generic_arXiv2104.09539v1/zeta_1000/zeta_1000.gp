...
# biased CX: 
# RUST_BACKTRACE=full cargo run --release -- tool fault_tolerant_benchmark [4,5,6] --djs [12,15,18] [12,15,18] [0.014] -b10 -p0 -m100000 -e3000 --use_xzzx_code --bias_eta 1000 --error_model GenericBiasedWithBiasedCX --no_stop_if_next_model_is_not_prepared --decoder UF --max_half_weight 10
# standard CX: 
# RUST_BACKTRACE=full cargo run --release -- tool fault_tolerant_benchmark [4,5,6] --djs [12,15,18] [12,15,18] [0.009] -b10 -p0 -m100000 -e3000 --use_xzzx_code --bias_eta 1000 --error_model GenericBiasedWithStandardCX --no_stop_if_next_model_is_not_prepared --decoder UF --max_half_weight 10
...
# biased CX
# RUST_BACKTRACE=full cargo run --release -- tool fault_tolerant_benchmark [4,5,6] --djs [12,15,18] [12,15,18] [0.0120,0.0125,0.0130,0.0135,0.0140] -b10 -p0 -m100000 -e100000 --use_xzzx_code --bias_eta 1000 --error_model GenericBiasedWithBiasedCX --decoder UF --max_half_weight 10
# standard CX
# RUST_BACKTRACE=full cargo run --release -- tool fault_tolerant_benchmark [4,5,6] --djs [12,15,18] [12,15,18] [0.0080,0.0085,0.0090,0.0095,0.0100] -b10 -p0 -m100000 -e100000 --use_xzzx_code --bias_eta 1000 --error_model GenericBiasedWithStandardCX --decoder UF --max_half_weight 10
...
set output '|ps2pdf -dEPSCrop zeta_1000.eps zeta_1000.pdf'
replot

set size 1,0.75
set output "zeta_1000_w.eps"
replot
set output '|ps2pdf -dEPSCrop zeta_1000_w.eps zeta_1000_w.pdf'
replot

set size 1,0.6
set output "zeta_1000_w_w.eps"
replot
set output '|ps2pdf -dEPSCrop zeta_1000_w_w.eps zeta_1000_w_w.pdf'
replot
