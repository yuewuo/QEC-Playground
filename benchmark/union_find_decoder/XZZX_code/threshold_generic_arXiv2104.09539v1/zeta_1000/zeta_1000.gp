...
# biased CX: 
# RUST_BACKTRACE=full cargo run --release -- tool fault_tolerant_benchmark [4,5,6] --djs [12,15,18] [12,15,18] [0.014]-p0 -m100000 -e3000 --use_xzzx_code --bias_eta 1000 --noise_model GenericBiasedWithBiasedCX --no_stop_if_next_model_is_not_prepared --decoder UF --max_half_weight 10
# standard CX: 
# RUST_BACKTRACE=full cargo run --release -- tool fault_tolerant_benchmark [4,5,6] --djs [12,15,18] [12,15,18] [0.009]-p0 -m100000 -e3000 --use_xzzx_code --bias_eta 1000 --noise_model GenericBiasedWithStandardCX --no_stop_if_next_model_is_not_prepared --decoder UF --max_half_weight 10
...
# biased CX
# RUST_BACKTRACE=full cargo run --release -- tool fault_tolerant_benchmark [4,5,6] --djs [12,15,18] [12,15,18] [0.0120,0.0125,0.0130,0.0135,0.0140]-p0 -m100000 -e100000 --use_xzzx_code --bias_eta 1000 --noise_model GenericBiasedWithBiasedCX --decoder UF --max_half_weight 10
# standard CX
# RUST_BACKTRACE=full cargo run --release -- tool fault_tolerant_benchmark [4,5,6] --djs [12,15,18] [12,15,18] [0.0080,0.0085,0.0090,0.0095,0.0100]-p0 -m100000 -e100000 --use_xzzx_code --bias_eta 1000 --noise_model GenericBiasedWithStandardCX --decoder UF --max_half_weight 10
