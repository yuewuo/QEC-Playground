...
# RUST_BACKTRACE=full cargo run --release -- tool fault_tolerant_benchmark [4,5,6] --djs [12,15,18] [12,15,18] [0.0005] -b10 -p0 -m100000 -e3000 --use_xzzx_code --bias_eta 1 --error_model GenericBiasedWithBiasedCX --no_stop_if_next_model_is_not_prepared --decoder UF --max_half_weight 10
# standard CX: 
# RUST_BACKTRACE=full cargo run --release -- tool fault_tolerant_benchmark [4,5,6] --djs [12,15,18] [12,15,18] [0.0008] -b10 -p0 -m100000 -e3000 --use_xzzx_code --bias_eta 1 --error_model GenericBiasedWithStandardCX --no_stop_if_next_model_is_not_prepared --decoder UF --max_half_weight 10


# data range:
# python -c "for i in range(5): print('%.5f' % (0.0006 + (i-2)*0.00005), end=',')"
# python -c "for i in range(5): print('%.5f' % (0.0007 + (i-2)*0.00005), end=',')"

# data generating commands:
# biased CX
# RUST_BACKTRACE=full cargo run --release -- tool fault_tolerant_benchmark [4,5,6] --djs [12,15,18] [12,15,18] [0.00050,0.00055,0.00060,0.00065,0.00070] -b10 -p0 -m100000 -e100000 --use_xzzx_code --bias_eta 1 --error_model GenericBiasedWithBiasedCX --decoder UF --max_half_weight 10
# standard CX
# RUST_BACKTRACE=full cargo run --release -- tool fault_tolerant_benchmark [4,5,6] --djs [12,15,18] [12,15,18] [0.00050,0.00055,0.00060,0.00065,0.00070,0.00075,0.00080,0.00085,0.00090] -b10 -p0 -m100000 -e100000 --use_xzzx_code --bias_eta 1 --error_model GenericBiasedWithStandardCX --decoder UF --max_half_weight 10
...
set title "Generaic Biased Noise Model (UF, {/Symbol z} = 1)"
