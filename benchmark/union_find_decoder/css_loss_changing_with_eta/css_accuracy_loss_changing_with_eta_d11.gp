...
set output '|ps2pdf -dEPSCrop css_accuracy_loss_changing_with_eta_d11.eps css_accuracy_loss_changing_with_eta_d11.pdf'
replot

set size 1,0.75
set output "css_accuracy_loss_changing_with_eta_d11_w.eps"
replot
set output '|ps2pdf -dEPSCrop css_accuracy_loss_changing_with_eta_d11_w.eps css_accuracy_loss_changing_with_eta_d11_w.pdf'
replot

set size 1,0.6
set output "css_accuracy_loss_changing_with_eta_d11_w_w.eps"
replot
set output '|ps2pdf -dEPSCrop css_accuracy_loss_changing_with_eta_d11_w_w.eps css_accuracy_loss_changing_with_eta_d11_w_w.pdf'
replot
