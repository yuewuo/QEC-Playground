...
set xlabel "Error Rate (p_X = p_Z, p_Y = p_X p_Z)" font "Arial, 28"
...
set output "independent_px_pz.eps"
...
set output '|ps2pdf -dEPSCrop independent_px_pz.eps independent_px_pz.pdf'
replot

set size 1,0.75
set output "independent_px_pz_w.eps"
replot
set output '|ps2pdf -dEPSCrop independent_px_pz_w.eps independent_px_pz_w.pdf'
replot

set size 1,0.6
set output "independent_px_pz_w_w.eps"
replot
set output '|ps2pdf -dEPSCrop independent_px_pz_w_w.eps independent_px_pz_w_w.pdf'
replot
