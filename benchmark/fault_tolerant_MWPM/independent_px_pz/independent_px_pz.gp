...
system("ps2pdf -dEPSCrop independent_px_pz.eps independent_px_pz.pdf")

set size 1,0.75
set output "independent_px_pz_w.eps"
replot
system("ps2pdf -dEPSCrop independent_px_pz_w.eps independent_px_pz_w.pdf")

set size 1,0.6
set output "independent_px_pz_w_w.eps"
replot
system("ps2pdf -dEPSCrop independent_px_pz_w_w.eps independent_px_pz_w_w.pdf")
