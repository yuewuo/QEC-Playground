...
# RUST_BACKTRACE=full cargo run --release -- tool fault_tolerant_benchmark [13,17,21,25] [0,0,0,0] [0.15,0.17,0.19,0.21]-p0 -m100000000 -e10000 --use_xzzx_code --shallow_error_on_bottom --bias_eta 1

# or joint commands
# RUST_BACKTRACE=full cargo run --release -- tool fault_tolerant_benchmark [13,17,21,25] [0,0,0,0] [0.15,0.16,0.17,0.18,0.19,0.20,0.21]-p0 -m100000000 -e1000000 --use_xzzx_code --shallow_error_on_bottom --bias_eta 1

set logscale x
set xrange [0.15:0.21]
# labels
# python -c "for i in range(7): print('\'%.2f\' %.2f' % tuple([0.18 + (i-3)*0.01 for j in range(2)]), end=', ')"
...
set title "XZZX code {/Symbol h} = 1 (MWPM decoder)"
...
system("ps2pdf -dEPSCrop threshold_bias_1.eps threshold_bias_1.pdf")

set size 1,0.75
set output "threshold_bias_1_w.eps"
replot
system("ps2pdf -dEPSCrop threshold_bias_1_w.eps threshold_bias_1_w.pdf")

set size 1,0.6
set output "threshold_bias_1_w_w.eps"
replot
system("ps2pdf -dEPSCrop threshold_bias_1_w_w.eps threshold_bias_1_w_w.pdf")
