...
set output "code_capacity_bias_inf_bell_init.eps"

set title "Tailored Code Capacity (Bell Init)"
...
system("ps2pdf -dEPSCrop code_capacity_bias_inf_bell_init.eps code_capacity_bias_inf_bell_init.pdf")

# set size 1,0.75
# set output "code_capacity_bias_inf_bell_init_w.eps"
# replot
# system("ps2pdf -dEPSCrop code_capacity_bias_inf_bell_init_w.eps code_capacity_bias_inf_bell_init_w.pdf")

# set size 1,0.6
# set output "code_capacity_bias_inf_bell_init_w_w.eps"
# replot
# system("ps2pdf -dEPSCrop code_capacity_bias_inf_bell_init_w_w.eps code_capacity_bias_inf_bell_init_w_w.pdf")
