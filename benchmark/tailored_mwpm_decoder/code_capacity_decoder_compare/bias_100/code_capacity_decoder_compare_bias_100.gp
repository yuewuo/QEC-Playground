...
set output "code_capacity_decoder_compare_bias_100.eps"

set title "Tailored Code Capacity (bias 100)"
...
system("ps2pdf -dEPSCrop code_capacity_decoder_compare_bias_100.eps code_capacity_decoder_compare_bias_100.pdf")

# set size 1,0.75
# set output "code_capacity_decoder_compare_bias_100_w.eps"
# replot
# system("ps2pdf -dEPSCrop code_capacity_decoder_compare_bias_100_w.eps code_capacity_decoder_compare_bias_100_w.pdf")

# set size 1,0.6
# set output "code_capacity_decoder_compare_bias_100_w_w.eps"
# replot
# system("ps2pdf -dEPSCrop code_capacity_decoder_compare_bias_100_w_w.eps code_capacity_decoder_compare_bias_100_w_w.pdf")
