...
set output "code_capacity_decoder_compare.eps"
...
system("ps2pdf -dEPSCrop code_capacity_decoder_compare.eps code_capacity_decoder_compare.pdf")

# set size 1,0.75
# set output "code_capacity_decoder_compare_w.eps"
# replot
# system("ps2pdf -dEPSCrop code_capacity_decoder_compare_w.eps code_capacity_decoder_compare_w.pdf")

# set size 1,0.6
# set output "code_capacity_decoder_compare_w_w.eps"
# replot
# system("ps2pdf -dEPSCrop code_capacity_decoder_compare_w_w.eps code_capacity_decoder_compare_w_w.pdf")
