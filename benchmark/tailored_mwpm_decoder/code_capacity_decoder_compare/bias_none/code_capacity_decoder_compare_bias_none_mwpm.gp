...
set output "code_capacity_decoder_compare_bias_none_mwpm.eps"

set title "Code Capacity (no bias) MWPM, HyperUF"

plot "mwpm/d_3.txt" using 1:6 with linespoints lt rgb "red" linewidth 4 pointtype 2 pointsize 1 notitle "d = 3",\
    "" using 1:6:($6*(1-$8)):($6*(1+$8)) with errorbars lt rgb "red" linewidth 4 pointtype 2 pointsize 1 notitle,\
    "mwpm/d_5.txt" using 1:6 with linespoints lt rgb "blue" linewidth 4 pointtype 2 pointsize 1 notitle "d = 5",\
    "" using 1:6:($6*(1-$8)):($6*(1+$8)) with errorbars lt rgb "blue" linewidth 4 pointtype 2 pointsize 1 notitle,\
    "mwpm/d_7.txt" using 1:6 with linespoints lt rgb "green" linewidth 4 pointtype 2 pointsize 1 notitle "d = 7",\
    "" using 1:6:($6*(1-$8)):($6*(1+$8)) with errorbars lt rgb "green" linewidth 4 pointtype 2 pointsize 1 notitle,\
    "mwpm/d_9.txt" using 1:6 with linespoints lt rgb "yellow" linewidth 4 pointtype 2 pointsize 1 notitle "d = 9",\
    "" using 1:6:($6*(1-$8)):($6*(1+$8)) with errorbars lt rgb "yellow" linewidth 4 pointtype 2 pointsize 1 notitle,\
    "mwpm/d_11.txt" using 1:6 with linespoints lt rgb "purple" linewidth 4 pointtype 2 pointsize 1 notitle "d = 11",\
    "" using 1:6:($6*(1-$8)):($6*(1+$8)) with errorbars lt rgb "purple" linewidth 4 pointtype 2 pointsize 1 notitle,\
    "mwpm/d_13.txt" using 1:6 with linespoints lt rgb "black" linewidth 4 pointtype 2 pointsize 1 notitle "d = 13",\
...
system("ps2pdf -dEPSCrop code_capacity_decoder_compare_bias_none_mwpm.eps code_capacity_decoder_compare_bias_none_mwpm.pdf")

# set size 1,0.75
# set output "code_capacity_decoder_compare_bias_none_mwpm_w.eps"
# replot
# system("ps2pdf -dEPSCrop code_capacity_decoder_compare_bias_none_mwpm_w.eps code_capacity_decoder_compare_bias_none_mwpm_w.pdf")

# set size 1,0.6
# set output "code_capacity_decoder_compare_bias_none_mwpm_w_w.eps"
# replot
# system("ps2pdf -dEPSCrop code_capacity_decoder_compare_bias_none_mwpm_w_w.eps code_capacity_decoder_compare_bias_none_mwpm_w_w.pdf")
