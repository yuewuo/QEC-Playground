...
parameters = f"-p{STO(0)} --time_budget {3600} --code_type RotatedTailoredCode --bias_eta 100 --decoder tailored-mwpm --decoder_config {{\"pcmg\":true}} --noise_model phenomenological".split(" ")
