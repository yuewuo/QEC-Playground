...
slurm_distribute.SLURM_DISTRIBUTE_CPUS_PER_TASK = 16  # for more usuable machines, use `SLURM_USE_SCAVENGE_PARTITION=1` flag
parameters = f"-p{STO(0)} --time_budget {3600} --code_type RotatedTailoredCode --bias_eta 1e200 --decoder tailored-mwpm --decoder_config {{\"pcmg\":true}} --error_model phenomenological".split(" ")
