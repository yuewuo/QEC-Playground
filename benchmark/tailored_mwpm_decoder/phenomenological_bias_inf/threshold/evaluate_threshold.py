...
slurm_distribute.SLURM_DISTRIBUTE_MEM_PER_TASK = '90G'  # necessary only for large code distances like 19 and 21
...
def experiment(slurm_commands_vec = None, run_command_get_stdout=run_qecp_command_get_stdout):
    ...
    def generate_command(p, d, runtime_budget, p_center=None):
        ...
        command = qecp_benchmark_simulate_func_command_vec(p, d, d, d+1, parameters, max_repeats=max_repeats, min_error_cases=min_error_case, time_budget=time_budget, p_graph=p_center)
        return command
