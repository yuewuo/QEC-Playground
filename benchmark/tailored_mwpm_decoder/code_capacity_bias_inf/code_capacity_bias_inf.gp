...
set output "code_capacity_bias_inf.eps"
...
system("ps2pdf -dEPSCrop code_capacity_bias_inf.eps code_capacity_bias_inf.pdf")

# set size 1,0.75
# set output "code_capacity_bias_inf_w.eps"
# replot
# system("ps2pdf -dEPSCrop code_capacity_bias_inf_w.eps code_capacity_bias_inf_w.pdf")

# set size 1,0.6
# set output "code_capacity_bias_inf_w_w.eps"
# replot
# system("ps2pdf -dEPSCrop code_capacity_bias_inf_w_w.eps code_capacity_bias_inf_w_w.pdf")
