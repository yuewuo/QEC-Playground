...
set output "code_capacity_bias_inf_uonc.eps"
...
system("ps2pdf -dEPSCrop code_capacity_bias_inf_uonc.eps code_capacity_bias_inf_uonc.pdf")

# set size 1,0.75
# set output "code_capacity_bias_inf_uonc_w.eps"
# replot
# system("ps2pdf -dEPSCrop code_capacity_bias_inf_uonc_w.eps code_capacity_bias_inf_uonc_w.pdf")

# set size 1,0.6
# set output "code_capacity_bias_inf_uonc_w_w.eps"
# replot
# system("ps2pdf -dEPSCrop code_capacity_bias_inf_uonc_w_w.eps code_capacity_bias_inf_uonc_w_w.pdf")
