		...
		return {
			...
			contents: {
				...
				"decoders": [
					...
					{ type: "text", content: "We've found an error pattern (already updated to your data qubits) that fails with 'Naive Decoder' but succeeds with 'MWPM Decoder'. Remember to switch display mode to 'Error' to view that error pattern. Try to run the two decoders one by one and see their difference. Click 'Next' to continue." },
