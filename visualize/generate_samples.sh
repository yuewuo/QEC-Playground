...
cargo run --release -- tool benchmark '[3]' '[3]' '[0.01]' --code-type standard-planar-code --noise-model stim-noise-model --decoder fusion --decoder-config '{"log_matchings":true}' --enable-visualizer --visualizer-filename rotated-surface-code-decoding-graph-d3.json --visualizer-model-graph --visualizer-model-hypergraph --deterministic-seed 123 -m 200
...
cargo run --release -- tool benchmark '[5]' '[5]' '[0.01]' --code-type standard-planar-code --noise-model stim-noise-model --decoder fusion --decoder-config '{"log_matchings":true}' --enable-visualizer --visualizer-filename rotated-surface-code-decoding-graph-d5.json --visualizer-model-graph --visualizer-model-hypergraph --deterministic-seed 123 -m 200
